...
export default class Update extends Component
{
    ...
    onSubmit(e){
        ...
        //alert(tripObject.id +"-"+tripObject.name+"-"+tripObject.description+"-"+tripObject.dateStarted+"-"+tripObject.dateCompleted) ;
        ...
        return(
            <div className="trip-form" >
                ...
                <form onSubmit={this.onSubmit}>
                    ...
                    <div className="form-group">
                        <button onClick = {this.CancelUpdate}  className="btn btn-Primary">Cancel</button>
